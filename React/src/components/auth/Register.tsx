...
import { authService, type RegisterCredentials } from '@/data/services/authService';
        ...
        <>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
                <p className="text-xs text-gray-500 text-center leading-relaxed">
                    <a href="/login" className="text-primary-700 hover:text-primary-600">Already have an account? Sign in</a>
                </p>
            </div>
        </>
    );
