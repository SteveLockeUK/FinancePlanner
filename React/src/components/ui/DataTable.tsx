            ...
            case 'date':
                ...
                if (value) {
                    if (typeof value === 'string') {
                        console.log("Value absolutely could be a string because this is a wank language which does wank things.")
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                ...
                <div className="overflow-x-auto">
                    ...
                    `}
                                >
                                    <div
                                        className={`flex items-center gap-2 ${column.fieldConfig?.type === 'number' ? 'justify-end' : 'justify-start'}`}>
                            ...
                            paginatedRows.map((row, rowIndex) => {
                                ...
                                return (
                                    <tr key={actualRowIndex}
                                        className={`hover:bg-gray-200 transition-colors ${actualRowIndex % 2 === 0 ? 'bg-gray-100' : 'bg-white'}`}>
                                    ...
                                    <div className="space-y-2">
                                        {columns.slice(0, 3).map(col => {
                                            ...
                                            return (
                                                <div key={col.key}>
                                                    <span
                                                        className="text-sm font-medium text-gray-600">{col.label}:</span>
