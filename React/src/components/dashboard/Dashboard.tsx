...
export default function Dashboard() {
    ...
    const fetchRecurringPayments = async () => {
        recurringPaymentService.getRecurringPayments()
            .then(recurringPayments => {
    ...
    return (
        <div>
            ...
            {
                selectedAccount && <RecurringPaymentTransactionDialog isOpen={isGenerateRecurringTransactionsDialogOpen}
                                                                      onClose={handleGenerateRecurringTransactions}
